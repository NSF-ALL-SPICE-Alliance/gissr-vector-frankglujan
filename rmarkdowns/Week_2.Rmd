...
ggplot() +
    geom_sf(data = world, fill = "lightgray") +
    geom_sf(data = islands, fill = "antiquewhite1", size = 0.25) +
    geom_sf(data = lakes110, fill = "darkblue", color = "black") +
    geom_sf(data = rivers110, color = "lightblue", size = 0.15) +
    geom_sf_text(data = islands, aes(label = name), size = 5, fontface = "bold", nudge_y = islands$nudge_y) +
    coord_sf(xlim = c(140, 146), ylim = c(12, 20), expand = FALSE) +
    ggtitle("Mariana Islands")+
    theme_void()
...
ggplot() +
    ...
    geom_sf(data = lakes110, fill = "darkblue", color = "black") +
    geom_sf(data = rivers110, color = "lightblue", size = 0.15) +
    geom_sf(data = guam, fill = "antiquewhite2", color = "red")+
    geom_text(data = islands, aes(x = longitude, y = latitude, label = name), size = 5, fontface = "bold", nudge_y = islands$nudge_y) +
    coord_sf(xlim = c(140, 146), ylim = c(12, 20), expand = FALSE) +
    ggtitle("Guam", subtitle = "in the Mariana Islands in the Western Pacific")+
    theme_void()
