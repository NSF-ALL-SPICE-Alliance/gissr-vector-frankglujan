...
ggplot(data = world) + geom_sf() + ggtitle("Countries of the World", subtitle = "Created by F. Lujan")
...
```{r Challenge 2}
world_without_australia <- world %>% filter(iso_a3 != "AUS")
```
...
ggplot() + 
  geom_sf(data = world_without_antarctica, 
          fill = "#20b2aa", color = "#18453b", size = 0.25) +
  ggtitle("Countries of the World", subtitle = "without Antarctica")
```
...
ggplot(data = world) +
  ...
  ggtitle("Mariana Islands as the Center of the World", subtitle = "Orthographic Azimuthal") +
  theme_void()
